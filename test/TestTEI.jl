...
@testset "Integral Transformation" begin
	...
	@testset "UHF" begin
		tei_transform(JuWfn3.uvsr,JuWfn3.Ca,JuWfn3.Cb,JuWfn3.Ca,JuWfn3.Cb,"TestTEImixed")
		rhf = tei_transform(JuWfn2.uvsr,JuWfn2.Ca,JuWfn2.Ca,JuWfn2.Ca,JuWfn2.Ca,"TestTEIrhf")
		uhf = tei_transform(JuWfn2.uvsr,JuWfn2.Ca,JuWfn2.Ca,JuWfn2.Ca,JuWfn2.Ca,"TestTEIuhf")
		@test rhf[:,:,:,:] ≈ uhf[:,:,:,:]
	end
    @testset "RHF subset" begin
        _Cao = wfn2.Ca_subset("AO","OCC")
        _Cav = wfn2.Ca_subset("AO","VIR")
        subset1 = tei_transform(JuWfn2.uvsr,JuWfn2.Cav,JuWfn2.Cao,JuWfn2.Cao,JuWfn2.Cav,"test")
        subset2 = tei_transform(JuWfn2.uvsr,JuWfn2.Cav,JuWfn2.Cav,JuWfn2.Cao,JuWfn2.Cao,"test2")
        subset3 = tei_transform(JuWfn2.uvsr,JuWfn2.Cao,JuWfn2.Cao,JuWfn2.Cao,JuWfn2.Cao,"test3")
